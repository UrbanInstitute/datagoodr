...
##   check if months > 3 ?  
##     what would a graph for one month look like? 
##     or one for time? 
##
##   can have max of 6 years, so need to create the table
##     and select top 6 years, 3 at a time (for layout)
...
# f <- factor( df$birthMonth, levels=order )
# barplot( table(f) )
...
calendarHeat <- 
  ...
  r2w <- colorRampPalette(c("gray40", "firebrick"))(5)
  r2g <- c("#D61818", "#FFAE63", "#FFFFBD", "#B5E384")   #red to green
  w2b <- c("#045A8D", "#2B8CBE", "#74A9CF", "#BDC9E1", "#F1EEF6")   #white to blue
  b2w <- c("#B3B3B3", "#879CA9", "#5B86A0", "#2F7096", "#045A8D")   #blue to white
  r2b <- colorRampPalette(c("#045A8D","gray70", "firebrick"))(5)
  b2r <- colorRampPalette(c("firebrick","gray70","#045A8D"))(5)
