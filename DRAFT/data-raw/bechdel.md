...
|bechdel_score |character | Rating (0-3) from Bechdeltest.com |
|bechdel_id    |character | ID from Bechdeltest.com |
...
b2 <- cleaned_bechdel[ c("title","id","rating") ]
names(b2) <- c("title","bechdelcom_id","bechdel_score")
m2 <- merge( movies, b2, by="title" )

write.csv( m2, "bechdel.csv", row.names=F, na="" )
```
