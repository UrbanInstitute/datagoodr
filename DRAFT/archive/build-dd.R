...
# div1 <- c( a1="dgf_vname" )
# div2 <- c( a1="dgf_vlabel", a2="label" )
# div3 <- 
#   c( a1 = "vtype", a1.lab = "variable type",
#      a2 = "vscope", a2.lab = "scope" )
# div4 <- c( a1 = "vdesc", a1.lab = "description" )


get_arg <- function( dsub, div )
{
   ...
   div3=div3 )
{
  ...
  # for( i in 1:nrows(dgf) ) 
  
  # dsub <- dgf[ i, ]
  
  # create_div1( x = dgf$dgf_vname[i] )
